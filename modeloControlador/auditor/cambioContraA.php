	...
	if(!$data){
		echo'
			 <script type="text/javascript">
  				window.location="../../vistas/auditor/cambioContrasenaA.php?E=2";
			 </script>
		';
	}
	else{
		...
		if($res){
			...
			echo'
			 <script type="text/javascript">
  				window.location="../../vistas/auditor/cambioContrasenaA.php?E=1";
			 </script>
		';
		}
		else{
			echo'
			 <script type="text/javascript">
  				window.location="../../vistas/auditor/cambioContrasenaA.php?E=0";
			 </script>
		';
		}
	}
