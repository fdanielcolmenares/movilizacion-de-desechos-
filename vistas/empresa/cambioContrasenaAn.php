...
<head>
  <meta charset="utf-8">
  <title>Cambio de Contrase&ntilda;a</title>
		...
		<div class="col-md-12 column"> <!-- col-md-10 col-md-offset-2-->
			...
			<div class="row clearfix">
				...
				<div class="col-md-9 column">
					...
					<form class="form-horizontal" id="cambioContraAn" name="cambioContraAn" action="../../modeloControlador/empresa/cambioContraAn.php" method="post">
						<fieldset>
