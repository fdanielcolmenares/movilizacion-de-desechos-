		...
		<div class="col-md-12 column"> <!-- col-md-10 col-md-offset-2-->
			...
			<div class="row clearfix">
				...
				<div class="col-md-9 column">
						...
						<?PHP 
							$sql="SELECT tipo from Empresa where idEmpresa=(select idEmpresa from Solicitud where sha1(idSolicitud)='".$cod."')"; 
							$res=mysql_query($sql);	
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        ...
						        <p>¿Esta seguro que desea rechazar la solicitud de <?PHP echo $data2["razon"];?> para transportar <?PHP echo $mat;?> hacia <?PHP echo $dest;?>?
						        </p>
						        <!-- Textarea -->
						        <form class="form-horizontal" id="registroPSolicitudR" name="registroPSolicitudR" action="../../modeloControlador/empresa/proSolicitud.php?id=<?PHP echo $cod; ?>&e=RECHAZADO" method="post">
								<p><strong>Indique el motivo:</strong></p>
								<div class="form-group">
								  <div class="col-md-9">                     
								    <textarea class="form-control" id="mot" name="mot"></textarea>
								  </div>
								</div>
						        </div>
						      ...
						      <div class="modal-footer">
						        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						        <button type="submit" id="rechazar" name="rechazar" class="btn btn-danger">Rechazar solicitud</button>
						      </div>
						      </form>
						    </div>
						  </div>
