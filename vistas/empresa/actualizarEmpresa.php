				...
				<div class="col-md-9 column">
					<form class="form-horizontal" id="modificaUsuario" name="modificaUsuario" action="#" method="post">
						...
						<div class="form-group">
						  <label class="col-md-4 control-label" for="nombre">Raz&oacute;n:</label>  
						  <div class="col-md-4">
						  <input id="nombre" name="nombre" type="text" placeholder="Ingrese razon social" class="form-control input-md">				    
						  </div>
						</div>						
						<!-- Button -->
						<div class="form-group">
...
<script>
	...
	function carga(){
		...
		$.ajax({ 
			type: "POST",
			url: "../../modeloControlador/empresa/cargaUsuariosM.php?p="+<?PHP echo $pag; ?>,
			data: dataString,
	...
	$(document).ready(function(){
		...
		$('#buscar').click(function(){ 
			...
			//if($('#nombre').val()!=""){ 
				...
				$.ajax({ 
					type: "POST",
					url: "../../modeloControlador/empresa/cargaUsuariosM.php?p=1",
					data: dataString,
					success: function(data) {	
						if(data=="-1"){ 
