		...
		<div class="col-md-12 column"> <!-- col-md-10 col-md-offset-2-->
			...
			<div class="row clearfix">
				...
				<div class="col-md-9 column">
					<form class="form-horizontal" id="consultaUsuario" name="consultaUsuario" action="#" method="post">
						<fieldset>
...
<script>
	...
	function carga(){
		...
		$.ajax({ 
			type: "POST",
			url: "../../modeloControlador/usuario/cargaUsuarios.php?t="+<?PHP echo "'".$op."'"; ?>+"&p="+<?PHP echo $pag; ?>,
			data: dataString,
	...
	$(document).ready(function(){
		...
		$('#buscar').click(function(){ 
			...
			//if($('#nombre').val()!=""){ 
				...
				var t = $("input:radio[name ='tipoC']:checked").val(); //alert(t);

				$.ajax({ 
					type: "POST",
					url: "../../modeloControlador/usuario/cargaUsuarios.php?t="+t+"&p=1",
					data: dataString,
					success: function(data) {	
						if(data=="-1"){ 
