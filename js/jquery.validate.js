...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Información inválida.",
		email: "Dirección de correo inválida.",
		url: "Dirección Url inválida.",
		date: "Fecha inválida.",
		dateISO: "Formato de fecha inválido.",
		number: "Valor Inválido.",
		digits: "Solo caracteres numéricos.",
		creditcard: "Número de tarjeta de credito inválido.",
		equalTo: "Los campos no coinciden.",
		maxlength: $.validator.format("El campo no puede contener mas de {0} caracteres."),
		minlength: $.validator.format("El campo no puede contener menos de {0} caracteres."),
